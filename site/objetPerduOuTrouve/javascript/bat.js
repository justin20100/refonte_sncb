function UET(o) {
    ...
    this.uetConfig = {};
    this.uetConfig.consent = {enabled: !1, adStorageAllowed: !0, adStorageUpdated: !1, hasWaited: !1, waitForUpdate: 0};
    this.beaconParams = {};
    ...
    this.legacyValidCustomEventKeyNames = {ec: 1, el: 1, ev: 1, ea: 1, gv: 1, gc: 1, prodid: 1, pagetype: 1};
    this.ambiguousValidCustomEventKeyNames = {ecomm_prodid: 1, ecomm_pagetype: 1, rep: 1};
    ...
    this.checkuetHostdocumentload = function () {
        ...
        if (n.documentLoaded = !!document.body && (!document.readyState || document.readyState === "interactive" || document.readyState === "complete" || document.readyState === "loaded") && !n.deferLoad, n.documentLoaded) {
            ...
            }, n.uetConfig.consent.waitForUpdate); else if (n.eventPushQueue.length > 0) {
    ...
    this.loadConfig = function () {
        ...
        o.Ver !== 1 ? (this.stringExists(o.tagId) && !this.stringExists(o.ti) && (o.ti = o.tagId), s = {
            ...
            Tag: 0,
            EXT_Data: 0
        }) : s = {Ver: 0, tagId: 0, Tag: 0, Sig: 0, EXT_Data: 0};
        for (u in o) s.hasOwnProperty(u) && (this.beaconParams[u] = s[u] === 1 ? encodeURIComponent(o[u]) : o[u]);
        for (this.beaconParams.mid = this.getUuidV4(!0), t = undefined, c = 0; c < 5; c++) if (t = "ueto_" + this.makeRandomStr(10), !window[t]) break;
        try {
        ...
        navigator.userAgentData && navigator.userAgentData.getHighEntropyValues && navigator.userAgentData.platform === "Windows" && (this.deferLoad = !0, i = this, l = setTimeout(function () {
            i.deferLoad = !1;
            i.fireSendBeacon("error", {msg: encodeURIComponent("Timeout requesting UA CH")})
            ...
            i.deferLoad = !1;
            clearTimeout(l);
            i.fireSendBeacon("error", {msg: encodeURIComponent("Error requesting UA CH: " + n)})
        }))
    };
    ...
    this.push = function () {
        var n = arguments, t, i, r = !1;
        if (n.length === 1) if (t = "event", n[0] === this.pageLoadEvt) i = [this.pageViewEvt, {}], r = !0; else {
            if (n[0] instanceof Array) if (n[0].length > 0) n[0] = n[0][0]; else return;
            i = ["", n[0] || {}];
            r = !0
        } else if (n.length > 1 && n[0] !== this.pageLoadEvt) t = n[0], i = Array.prototype.slice.call(n, 1); else return;
    ...
    this._push = function (n) {
        var e, r, o, u, t, f, i;
        if (n[1] instanceof Array) if (n[0] === "event") {
    ...
    this.dispatchq = function (n) {
        var t, i, r, u, e, o, f;
        for (n || (this.evqDispatch = !0, this.uetConfig.disableVisibilityEvents === !1 && "onpagehide" in window && (window.addEventListener("pageshow", this.firePageShow.bind(this)), window.addEventListener("pagehide", this.firePageHide.bind(this)))), r = 0; r < this.evq.length; r++) if (typeof this.evq[r] == "object") {
            if (u = this.evq[r], t === "set") n && this.push(t, u); else if (t === "consent") n && i !== undefined && this.push(t, i, u); else if (!n) if (t === "event") {
                e = !1;
                for (o in this.legacyValidCustomEventKeyNames) if (u.hasOwnProperty(o)) {
                    e = !0;
                    break
                }
    ...
    this.addPluginData = function (n) {
        for (var r, u, t, f = [], i = 0; i < window.navigator.plugins.length; i++) f.push({name: window.navigator.plugins[i].name});
    ...
    this.addUrlData = function (n) {
        ...
        if (window.window != window.top) try {
            for (u = 0, i = window.window; u <= 5 && i != null && i != window.top; u++, i = i.parent) if (i.document != null && this.stringExists(i.document.referrer) && i.document.referrer.toLowerCase() !== "about:blank") {
    ...
    this.helperError = function (n) {
        if (typeof CustomEvent == "function") {
            var t = {errMsg: n, tagId: this.beaconParams.ti}, i = new CustomEvent("uetError", {detail: t});
    ...
    this.throwError = function (n) {
        if (this.helperError(n), this.uetConfig.errorBeaconLevel > 0) {
            ...
            var t = this.combine(this.beaconParams, {errMsg: encodeURIComponent(n)}), i = this.stringifyToRequest(t),
    ...
    this.sha256 = function n(t) {
        ...
        var u, it, b;
        try {
            for (var d, h, c = Math.pow, l = c(2, 32), e = "length", k = "push", g = "", o = [], nt = 8 * t[e], i = n.h = n.h || [], a = n.k = n.k || [], v = a[e], tt = {}, f = 2; 64 > v; f++) if (!tt[f]) {
            ...
            for (o[k](nt / l | 0), o[k](0 | nt); o[e];) {
                for (u = o.splice(0, 16), it = i, i = i.slice(0, 8), d = 0; 64 > d; d++) {
                    var y = u[d - 15], p = u[d - 2], s = i[0], w = i[4],
            ...
            for (d = 0; 8 > d; d++) for (h = 24; h >= 0; h -= 8) b = i[d] >> h & 255, g += (16 > b ? "0" : "") + b.toString(16);
            return g
        } catch (h) {
            return ""
        }
    ...
    this.validateSubparams = function (n, t) {
        var f = {}, i, u, r;
        for (i in n) if (this.knownParams.hasOwnProperty(t + i) && n[i] != null) {
    ...
    this.evt = function (n, t, i, r) {
        ...
        if (r = r !== !1, i = i || {}, this.evqDispatch === !1 && this.dispatchq(!0), this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(!1), typeof i == "object") {
            if (this.uetConfig.allRep === !0 ? i.rep = "1" : i.hasOwnProperty("rep") && (i.rep === 1 || i.rep === "1" || i.rep === !0 ? i.rep = "1" : delete i.rep), n === this.pageLoadEvt && (this.uetConfig.gtagPid === !0 && "enhanced_conversion_data" in window && typeof enhanced_conversion_data == "object" && (this.pageLevelParams.pid = {em: window.enhanced_conversion_data.email}), r && this.pageLevelParams.hasOwnProperty("pid") && !i.hasOwnProperty("pid") && (i.pid = this.pageLevelParams.pid)), r ? this.validateDataObject(n, i) : (i.event_action = t, n === this.customEvt && i.hasOwnProperty("gtm_tag_source") && (i = this.mapGtmParams(i)), i = this.validateDataObjectNew(n, i)), n === this.customEvt) {
                s = [];
                for (v in i) s.push(v);
    ...
    this.getCookie = function (n, t, i) {
        ...
        for (this.stringExists(t) || (t = ""), e = 0; e < r.length;) {
            ...
            if (u > 0 && r[u - 1] !== " " && r[u - 1] !== ";") e = u + n.length + 1; else break
        }
    ...
    this.setCookie = function (n, t, i, r, u, f, e) {
        ...
        if (h = new Date, h.setTime(h.getTime() + i * 1e3), l = new Date, l.setTime(0), u && this.setLocalStorageBackup(n, t, i), this.domainName === null || r) {
            if (c = this.getHostname(), c && typeof c == "string" && c !== "localhost") for (s = c.split("."), o = s.pop(), s.length === 3 && Number(o) >= 0 && (s = []); s.length > 0;) if ((o = s.pop() + "." + o, this.uetConfig.cookieDomain === "" || this.uetConfig.cookieDomain.toLowerCase() === o.toLowerCase()) && (r && (this._setCookie(n, "", l, o, this.uetConfig.cookieFlags), r = !!this.getCookie(n, f, e)), !r && (this._setCookie(n, f + t, h, o, this.uetConfig.cookieFlags), this.getCookie(n, f, e)))) {
                this.domainName = o;
                return
            }
            this.domainName = ""
    ...
    this.getQueryParam = function (n, t) {
        ...
        var i = new RegExp("[?&]" + t + "=([^&#]*)", "i"), r = i.exec(n) || [, null];
        return r[1]
    };
    this.addCookieId = function (n, t, i, r, u) {
        ...
        var e = "2", o = !0, f = this.getCookie(r, "", this.cookieIdMaxLength);
    ...
    this.fireSendBeacon = function (n, t) {
        var i = this.combine(this.beaconParams, {evt: n}), r;
        t && (i = this.clone(t, i));
    ...
    this.mapGtmUasProducts = function (n) {
        ...
        if (n.hasOwnProperty("ecomm_totalvalue")) {
            if (n.ecomm_pagetype = "purchase", n.ecomm_prodid = [], n.items = [], n.hasOwnProperty("transactionProducts") && n.transactionProducts instanceof Array) for (r = 0; r < n.transactionProducts.length; r++) (t = n.transactionProducts[r], typeof t == "object") && (i = {}, t.hasOwnProperty("sku") && (i.id = t.sku, n.ecomm_prodid.push(i.id)), t.hasOwnProperty("price") && (i.price = t.price), t.hasOwnProperty("quantity") && (i.quantity = t.quantity), n.items.push(i));
    ...
    this.mapGtmEcommercePurchase = function (n) {
        ...
        if (n.hasOwnProperty("ecommerce") && typeof n.ecommerce == "object") {
            if (n.ecommerce.hasOwnProperty("ecommerce") && typeof n.ecommerce.ecommerce == "object" && (n.ecommerce = n.ecommerce.ecommerce), n.ecommerce.hasOwnProperty("purchase") && typeof n.ecommerce.purchase == "object") t = n.ecommerce.purchase, n.ecomm_pagetype = "purchase"; else if (n.ecommerce.hasOwnProperty("add") && typeof n.ecommerce.add == "object") t = n.ecommerce.add, n.ecomm_pagetype = "cart"; else if (n.ecommerce.hasOwnProperty("click") && typeof n.ecommerce.click == "object") t = n.ecommerce.click, n.ecomm_pagetype = "product"; else if (n.ecommerce.hasOwnProperty("detail") && typeof n.ecommerce.detail == "object") t = n.ecommerce.detail, n.ecomm_pagetype = "product"; else if (n.ecommerce.hasOwnProperty("impressions") && n.ecommerce.impressions instanceof Array) t = {products: n.ecommerce.impressions}, n.ecomm_pagetype = "other"; else {
                delete n.ecommerce;
                return
            }
            if (n.ecommerce.hasOwnProperty("currencyCode") && (n.currency = n.ecommerce.currencyCode), t.hasOwnProperty("actionField") && typeof t.actionField == "object" && (t.actionField.hasOwnProperty("id") && (n.transaction_id = t.actionField.id), t.actionField.hasOwnProperty("revenue") && (n.ecomm_totalvalue = t.actionField.revenue)), t.hasOwnProperty("products") && t.products instanceof Array) for (n.ecomm_prodid = [], n.items = [], u = 0; u < t.products.length; u++) (i = t.products[u], typeof i == "object") && (r = {}, i.hasOwnProperty("id") && (r.id = i.id, n.ecomm_prodid.push(r.id)), i.hasOwnProperty("price") && (r.price = i.price), i.hasOwnProperty("quantity") && (r.quantity = i.quantity), n.items.push(r));
            delete n.ecommerce
        }
    };
